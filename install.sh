    ...
    sudo -u "$ACTUAL_USER" bash -c "cat > $SYS_CONFIG_FILE" << EOL
{
    ...
    "video_decode": {"backend": "auto", "hw_acceleration": "auto", "hw_device": "/dev/dri/renderD128", "vaapi_driver": "iHD", "fallback_to_cpu": true, "log_interval_sec": 10.0, "print_pipeline_logs": true},
